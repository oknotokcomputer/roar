...
load("//third_party/lexan/build_defs:lexan_cc_windows_dll.bzl", "lexan_cc_windows_dll")
...
lexan_cc_windows_dll(
    name = "cperfetto",
    linkopts = ["ws2_32.lib"],
    srcs = [
        "src/tracing/ctrace.cc"
    ],
    hdrs = [
